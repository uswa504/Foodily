...
<center><h1> Add Delivery Boy </h1></center>
<div class="login-page">
  <div class="form">
    <form class="add-delboy-form-form" action="added.php" method="post" >
      <input type="text" name="n" placeholder="Enter name"/>
      <input type="text" name="cnic" placeholder="Enter CNIC"/>
	  <input type="text" name="contact" placeholder="Enter conatct"/>
      <button>Add</button>
    </form>
  </div>
</div>
